...
export default function DetailPageLoadingSkeleton() {
  return (
    <Fragment>
      ...
      <div className="grid grid-cols-12 gap-4">
        ...
        <Skeleton className="h-[25px] w-full lg:w-[500px] bg-gray-700 mb-2" />
        <Skeleton className="h-[20px] w-full lg:w-[100px] bg-gray-700 mb-2" />

        <Skeleton className="h-[40px] w-full lg:w-[800px] bg-gray-700 mb-2" />

        <Skeleton className="h-[40px] w-full lg:w-[200px] bg-gray-700 mb-2" />
              ...
              <div className="col-span-12 sm:col-span-4">
                <div className="grid grid-cols-12 gap-4">
                  <div className="col-span-6 sm:col-span-12">
                    ...
                    <Skeleton className="h-[30px] mt-2 w-full bg-gray-700" />
                    <Skeleton className="h-[30px] mt-2 w-full bg-gray-700" />
                    <Skeleton className="h-[30px] mt-2 w-full bg-gray-700" />
                    <Skeleton className="h-[30px] mt-2 w-full bg-gray-700" />
                    <Skeleton className="h-[30px] mt-2 w-full bg-gray-700" />
